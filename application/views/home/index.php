...
<html>
  <head>
    ...
    <!-- Select2 -->
    <link href="<?php echo URL; ?>public/select2.css" rel="stylesheet" media="screen">

    <!-- Updates -->
    <link href="<?php echo URL; ?>public/css/updates/update1/css/style01.css" rel="stylesheet" media="screen">	
    ...
    <!-- Masonry -->
	<link href="<?php echo URL; ?>public/css/updates/update1/css/masonry.css" rel="stylesheet">
	<script src="<?php echo URL; ?>public/js/updates/update1/js/masonry.pkgd.js"></script>
	<script>
  ...
  <body id="top">
		...
		<div class="navbar mtnav2">
			...
			<div class="container offset-3">
			  ...
			  <div class="navbar-header">
				...
				<a href="index.html" class="navbar-brand"><img src="<?php echo URL; ?>public/img/updates/update1/img/logo.png" alt="Travel Agency Logo" class="logo2"/></a>
			  </div>
	...
	<div id="dajy" class="fullscreen-container2 mtslideb sliderbg fixed">
			...
			<span class="lato size48 slim white ">Where do you want to go?</span><br/>
				<form action="<?php echo URL; ?>listing/" method="POST">
				<div class="wh90percent">
				<div class="w50percent">
				<select id="selectModel" name="model" style="width:100%;">
					<option></option>
					<?php foreach ($bikeModels as $bikeModel) { ?>
				        <option value="AL"><?php echo $bikeModel?></option>
					<?php } ?>
				</select>
				</div>
				
				<div class="w50percentlast">
				<select id="selectLocation" style="width:100%">
					<option></option>
				        <option value="AL">Gachibowli</option>
				        <option value="AL">Kondapur</option>
					<option value="WY">White Fields</option>
					<option value="WY">Nanakramguda</option>
				</select>
				</div>
				</div>


				<button type="submit" name="submit_list_bike" class="btn btn-default nbtn-search right" type="button">
			...
			<div class="fullscreenbanner">
				<ul>
					...
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						<img src="<?php echo URL; ?>public/img/updates/update1/img/slider/slide1.jpg" alt=""/>
					...
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						...
						<img src="<?php echo URL; ?>public/img/updates/update1/img/slider/slide2.jpg" alt=""/>
						<div class="tp-caption scrolleffect sft"
							 data-x="center"
							 data-y="120"
							 data-speed="1000"
					...
					<!-- FADE -->
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						<img src="<?php echo URL; ?>public/img/updates/update1/img/slider/slide3.jpg" alt=""/>
						<div class="tp-caption scrolleffect sft"
							 data-x="center"
							 data-y="120"
							 data-speed="1000"
	...
	<div class="wrap cst03 bgfix " >
		...
		<div class="masonry">
			<div class="item wt2 ht2">
				<div class="msbox2"><a href="#"><img src="<?php echo URL; ?>public/img/updates/update1/img/pic01.jpg" class="fhimg2 left" alt=""></a></div>
			</div>
			<div class="item ht2">
				<div class="msbox2">
				<a href="#"><img src="<?php echo URL; ?>public/img/updates/update1/img/pic02.jpg" class="fhimg" alt=""></a>
			...
			<div class="item ">
				<div class="msbox"><a href="#"><img src="<?php echo URL; ?>public/img/updates/update1/img/pic03.jpg" class="fhimg" alt=""></a></div>
			</div>
			<div class="item ht2">
				<div class="msbox2"><a href="#"><img src="<?php echo URL; ?>public/img/updates/update1/img/pic04.jpg" class="fhimg" alt=""></a>
					<p class="msctext padding20">
			...
			<div class="item wt2">
				<div class="msbox">
					...
					<div class="w50percentlast right">
						<a href="#"><img src="<?php echo URL; ?>public/img/updates/update1/img/pic06.jpg" class="fwimg " alt=""></a>
					</div>
				</div>
			</div>
			<div class="item">
				<div class="msbox"><a href="#"><img src="<?php echo URL; ?>public/img/updates/update1/img/pic05.jpg" class="fhimg" alt=""></a></div>
			</div>
		...
		<div class="footerbg lcfix">
			<div class="container">		
				<footer>
					<div class="footer">
						<a href="#" class="social1"><img src="<?php echo URL; ?>public/img/images/icon-facebook.png" alt=""/></a>
						<a href="#" class="social2"><img src="<?php echo URL; ?>public/img/images/icon-twitter.png" alt=""/></a>
						<a href="#" class="social3"><img src="<?php echo URL; ?>public/img/images/icon-gplus.png" alt=""/></a>
						<a href="#" class="social4"><img src="<?php echo URL; ?>public/img/images/icon-youtube.png" alt=""/></a>
						<br/><br/>
						Copyright &copy; 2013 <a href="#">Travel Agency</a> All rights reserved. <a href="http://titanicthemes.com">TitanicThemes.com</a>
						<br/><br/>
						<a href="#top" id="gotop2" class="gotop"><img src="<?php echo URL; ?>public/img/images/spacer.png" alt=""/></a>
					</div>
				</footer>
			</div>	
		</div>
    ...
    <!-- This page JS -->
	<script src="<?php echo URL; ?>public/js/updates/update1/js/js-new-homepage.js"></script>	
    ...
    <!-- CarouFredSel -->
    <script src="<?php echo URL; ?>public/js/assets/js/jquery.carouFredSel-6.2.1-packed.js"></script>
    <script src="<?php echo URL; ?>public/js/assets/js/helper-plugins/jquery.touchSwipe.min.js"></script>
	<script type="text/javascript" src="<?php echo URL; ?>public/js/assets/js/helper-plugins/jquery.mousewheel.min.js"></script>
	<script type="text/javascript" src="<?php echo URL; ?>public/js/assets/js/helper-plugins/jquery.transit.min.js"></script>
	<script type="text/javascript" src="<?php echo URL; ?>public/js/assets/js/helper-plugins/jquery.ba-throttle-debounce.min.js"></script>
